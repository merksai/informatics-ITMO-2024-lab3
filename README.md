...
![](screenshots/16.png)
![](screenshots/17.png)
На скриншоте видно, что основная виртуальная машина имеет связь и с Б, и с В. Так же, как и Б, и В машины имеют связь с А. А вот связи между Б и В нет – они находятся в разных подсетях. 
